...
name="email" placeholder="Alamat Email" required>
                ...
                <div class="form-group">
                  ...
                  <input type="tel" class="form-control" id="telpon" 
name="telpon" placeholder="Nomor HP" required>
                </div>
                <div class="form-group">
                  <label for="tanggalMulai">Tanggal Pemakaian</label>
                  <input type="date" class="form-control" 
id="tanggalMulai" name="tanggalMulai" onchange="hitung()" required>
                </div>
                <div class="form-group">
                  <label for="tanggalKembali">Tanggal 
Pengembalian</label>
                  <input type="date" class="form-control" 
id="tanggalKembali" name="tanggalKembali" onchange="hitung()" required>
                </div>
                <div class="form-group">
                	<label for="hargaHarian">Harga Perhari</label>
                	<input type="text" class="form-control" 
id="hargaHarian" name="hargaHarian" value="Harga" required disabled>
                </div>
                <div class="form-group">
...
name="total"required readonly>
              ...
              <div class="box-footer">
                <button name="booking" type="submit" class="btn 
...
href="#">Jaklom</a>.</strong> All rights
	...
	<script>
		function GetDays(){
			var awal  = new 
Date(document.getElementById('tanggalMulai').value);
			var akhir = new 
Date(document.getElementById('tanggalKembali').value);
			return parseInt((akhir - awal) / 
(24*3600*1000));
		}
		function hitung(){
